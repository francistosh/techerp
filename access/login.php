...
function defaultCompany()
{
	...
	if (!$login_timeout)
		table_section_title(_("")." ".$SysPrefs->app_title." - "._("Login"));
	...
	echo "</tr>";
        echo "<tr>\n";
	echo "<td><a target='_blank' href='".$SysPrefs->power_url."' tabindex='-1'>".$SysPrefs->app_title." - Copyright &copy ".date('Y')."</a></td>\n";
	echo "</tr>\n";
        echo "</table>\n";
